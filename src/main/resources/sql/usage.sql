...
(Select ttlrecs,inserted, EXTRACT(EPOCH FROM AGE(dt, '"2014-05-24 01:16:58.977088+00"')) as secs,dt FROM (SELECT Count(*) as ttlrecs, (Count(*)-4011613) as inserted, now() as dt FROM webui_usage) as a) as b;
